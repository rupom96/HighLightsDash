...
const Sidebar = () => {
    ...
    const normalLink = 'flex items-center gap-5 pl-4 pt-3 pb-2.5 rounded-lg text-white text-md text-gray-700 transform-all duration-300 dark:text-gray-200 dark:hover:text-black dark:hover:text-lg dark:hover:transform-all duration-300 hover:transform-all duration-300 hover:text-lg hover:bg-light-gray m-2'
            ...
            {activeMenu && (<>
                <div className='flex justify-between items-center'>
                    ...
                    <Link to="/" className='items-center gap-3 ml-3 mt-4 flex text-xl font-extrabold tracking-tight dark:text-white text-slate-900' onClick={handleCloseSidebar}>
                        <div className="animate-bounce flex items-center gap-5"><SiShopware /> <span>HighLights</span></div>
                    </Link>
